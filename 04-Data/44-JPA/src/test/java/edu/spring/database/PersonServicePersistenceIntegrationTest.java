...
import edu.spring.database.config.PersistenceJPAConfigXml;
...
public class PersonServicePersistenceIntegrationTest {
    ...
    public final void whenEntityIsCreated_thenNoExceptions() {
        service.create(new PersonEntity(randomAlphabetic(6),new Address("Musterstrasse", 2), null));
    }

    @Test(expected = DataIntegrityViolationException.class)
    public final void whenInvalidEntityIsCreated_thenDataException() {
        service.create(new PersonEntity(randomAlphabetic(2048),new Address("Musterstrasse", 2), null));
    }
